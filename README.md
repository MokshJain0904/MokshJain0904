...
| Attribute | Details |
|---|---|
| **Stack** | TypeScript, Next.js, Tailwind CSS, AI |
| **Scale** | Web-based privacy analysis application |
| **Performance** | Structured permission analysis workflow |
| **Security** | Privacy-focused permission analysis |
| **Impact** | Helps users understand application permission risks |
| **Repository** | [app-privacy-analyser](https://github.com/MokshJain0904/app-privacy-analyser) |

**Skills:** `TypeScript` `Next.js` `Tailwind CSS` `AI` `Privacy Analysis`
...
| **Scale** | Hotel booking demand dataset |
| **Performance** | Structured data-processing and visualization workflow |
| **Security** | Controlled analytical dataset processing |
| **Impact** | Converts booking data into business-oriented insights |
| **Repository** | [Smart-Travel-Analytics-BI-Dashboard](https://github.com/MokshJain0904/Smart-Travel-Analytics-BI-Dashboard) |

**Skills:** `Python` `Pandas` `NumPy` `Power BI` `Data Analytics` `Data Visualization`
...
| Attribute | Details |
|---|---|
| **Stack** | Python, Pandas, NumPy, Scikit-learn, NLTK, MLxtend |
| **Scale** | Multi-stage data mining and analytics workflow |
...
| **Scale** | Backend learning repository |
| **Performance** | Lightweight server-side JavaScript |
| **Security** | Backend development fundamentals |
| **Impact** | Strengthens understanding of server-side JavaScript |
| **Repository** | [Node-JS-Bootcamp](https://github.com/MokshJain0904/Node-JS-Bootcamp) |
...
| **Impact** | Practical implementation of web-development fundamentals |
| **Repository** | [campusDeal](https://github.com/MokshJain0904/campusDeal) |

**Skills:** `HTML` `CSS` `Frontend Development` `Web Design`
